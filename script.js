...
function countn() {
//https://api.countapi.xyz/create?namespace=Word&key=sushmitanidhi&value=0
//https://api.countapi.xyz/get/Word/sushmitanidhi
//https://api.countapi.xyz/update/Word/sushmitanidhi/?amount=1
return fetch('https://api.countapi.xyz/update/Word/sushmitanidhi/?amount=1')
.then(res=>res.json())
.then(data=>count.innerHTML=data.value)
}

function getcount(){
  return fetch('https://api.countapi.xyz/get/Word/sushmitanidhi')
  .then(res => res.json())
  .then(data => count.innerHTML=data.value)
}
